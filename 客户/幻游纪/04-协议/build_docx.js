...
// ---------- 内容 ----------
// Franklin 2026-09-07：别写太具体。只写清楚：大概交付时间、付款要求、赔偿条款。
const 费用表 = {
  cols: [2400, 2800, 4160],
  rows: [
    ["项目", "费用", "说明"],
...
const 赔偿 = [
  ...
  "乙方质量：交付物经两轮修复仍不能通过验收的，甲方有权解除本备忘录，乙方按未完成工作量比例退还该阶段已收费用；除此之外不承担其他赔偿责任。",
  "甲方逾期付款：每逾期 1 日按应付未付金额的 0.5% 支付违约金；逾期超过 15 日乙方有权暂停服务，逾期超过 30 日乙方有权解除本备忘录并保留已完成部分的费用。",
