...
// ---------- 内容 ----------
// Franklin 2026-09-07：别写太具体。只写清楚：大概交付时间、付款要求、赔偿条款。赔偿不含「质量退款」和「甲方逾期付款违约金」两条（Franklin 去掉）。暂不提「叠加开发」（Franklin 09-07）。10 月 = 基础商用版：几十用户 + 付费 + 下载（Franklin 09-07）。⭐ 路线 = H5 网页扫码打开，不是小程序（Franklin 09-07：目前上不了小程序，街上宣传扫码进网站）。
const 费用表 = {
  cols: [2400, 2800, 4160],
  rows: [
    ["项目", "费用", "说明"],
...
const toParty = (x) => x.replaceAll("贵方", "甲方").replaceAll("由我承担", "由乙方承担");
